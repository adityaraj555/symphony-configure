locals {
  ...
  ARN_IMAGERY_CHECK      = "arn:aws:lambda:us-east-2:633128282718:function:app-stage-1x0-lambda-imagery-check"
  ARN_BUILDING_DETECTION = "arn:aws:lambda:us-east-2:633128282718:function:app-stage-1x0-lambda-building-detection"
  ARN_IMAGE_SELECTION    = "arn:aws:lambda:us-east-2:633128282718:function:app-stage-1x0-lambda-image-selection"
  ARN_UPLOAD_IMAGE       = "arn:aws:lambda:us-east-2:633128282718:function:app-stage-1x0-lambda-uploadimage"
