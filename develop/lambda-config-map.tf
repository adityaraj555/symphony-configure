...
output "lambda_configmap" {
  ...
  value = {
    ...
    "${local.throttleservice_lambda_name}" = {
      image_uri          = "${local.ecr_path}/${local.throttleservice_lambda_name}:9b614a3.121"
      vpc_id             = local.lambda_vpc_id,
      lambda_handler     = null
      lambda_description = "Lambda"
      package_type       = "Image"
    ...
    "${local.evmlconveter_lambda_name}" = {
      image_uri          = "${local.ecr_path}/${local.evmlconveter_lambda_name}:9b614a3.120"
      lambda_handler     = null
      lambda_description = "Lambda"
      package_type       = "Image"
      timeout            = 60
    ...
    "${local.sim_to_pdw_lambda_name}" = {
      image_uri          = "${local.ecr_path}/${local.sim_to_pdw_lambda_name}:87cdada.135"
      lambda_handler     = null
      lambda_description = "Lambda"
      package_type       = "Image"
      timeout            = 60
